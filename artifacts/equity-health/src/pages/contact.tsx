          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-text-muted">123 Independence Avenue, Ridge, Accra</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="bg-bg-surface p-3 rounded-full shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-text-muted">0800 123 456 (Toll Free)<br/>+233 24 000 0000</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="bg-bg-surface p-3 rounded-full shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-text-muted">support@equityhealth.com.gh</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input id="name" placeholder="John Doe" className="bg-white border-brand-navy-light/20" />
                    </div>
                    <div className="space-y-2">
                      <label htmlFor="phone" className="text-sm font-medium text-brand-navy">Phone Number</label>
                      <Input id="phone" placeholder="+233 24..." className="bg-white border-brand-navy-light/20" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="email" className="text-sm font-medium text-brand-navy">Email Address</label>
                    <Input id="email" type="email" placeholder="john@example.com" className="bg-white border-brand-navy-light/20" />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="message" className="text-sm font-medium text-brand-navy">Message</label>
                    <Textarea id="message" placeholder="How can we help you?" className="min-h-[120px] bg-white border-brand-navy-light/20" />
                  </div>
                  <Button type="button" className="w-full bg-brand-red hover:bg-brand-red/90 text-white font-semibold h-12 text-base" data-testid="button-submit-contact">
                    Send Message
                  </Button>
                  <p className="text-xs text-text-muted text-center italic mt-4">
                    This form is for demonstration purposes only. No data is submitted.
                  </p>
                </form>
              </div>
            </div>
            ...
            <div>
              ...
              <Accordion type="single" collapsible className="w-full space-y-4">
                {faqs.map((faq, index) => (
                  <AccordionItem key={index} value={`item-${index}`} className="bg-bg-surface border border-brand-navy-light/10 rounded-lg px-4 shadow-sm data-[state=open]:bg-white transition-colors">
